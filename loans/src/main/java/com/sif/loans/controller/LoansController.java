package com.sif.loans.controller;
...
@Tag(
        name = "CRUD REST APIs for Loans in SifBank",
        description = "CRUD REST APIs in SifBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
